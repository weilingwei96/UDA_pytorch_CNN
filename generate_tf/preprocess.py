...
flags.DEFINE_string(
    "raw_data_dir", "../data/IMDB_raw/unsup.txt", "Data directory of the raw data")

# TODO CHANGE
flags.DEFINE_string(
    "aug_raw_data_dir", "../data/IMDB_raw/unsup_aug.txt", "Data directory of the raw data")



flags.DEFINE_string(
    "output_base_dir", "../data/proc_data/unsup", "Data directory of the processed data")
...
flags.DEFINE_string(
    "vocab_file", "/root/wlw/UDA_pytorch/Chinese_BERT_model/vocab.txt", "The path of the vocab file of BERT.")

flags.DEFINE_bool(
    "do_lower_case", True, "Whether to use uncased text for BERT.")

flags.DEFINE_string(
    "back_translation_dir", "back_translation/imdb_back_trans", "Directory for back translated sentence.")
...
def proc_and_save_unsup_data(
  ...
  aug_examples = processor.get_unsup_examples(aug_raw_data_dir, sub_set)
...
def main(_):
  ...
  if FLAGS.data_type == "sup":
    ...
    proc_and_save_unsup_data(
        ...
        aug_raw_data_dir=FLAGS.aug_raw_data_dir)
